...
Criando uma estrutura completa com dois serviços backend e uma aplicação web.
No backend temos um serviço de compras(purchases) onde o customer realiza uma compra e no serviço de sala de aula(classroom) assim que é realizado uma compra ele cria uma matrícula para o estudante que no serviço de compras ele era o customer mas no serviço de sala de aula ele é um estudante.
